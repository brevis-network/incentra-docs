...
* Powered by [Brevis zkCoprocessor](https://coprocessor-docs.brevis.network/), rewards are calculated directly in the ZK circuits and directly verified on-chain, ensuring trustless, transparent and verifiable reward computation. Users can independently verify reward amounts without relying on any centralized authority.
